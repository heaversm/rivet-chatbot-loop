...
app.get('/api/result', async (req, res) => {
    try {
        ...
        if (typeof result === 'string') {
            ...
            console.error('Expected result to be a string, received:', typeof result);
